...
const About = () => {
  return (
    <Box
      sx={{ boxSizing: "border-box", mx: "20em", pt: "20em", height: "100vh" }}
    >
      <Grid
        container
        spacing={10}
        sx={{ textAlign: "left", backgroundColor: "#111111", pb: "4em" }}
      >
        <Grid item xs={4}>
          <Card>
          ...
          <Card>
            ...
            <Grid container spacing={4}>
              <Grid item xs={4}>
                ...
                <Typography variant="h5">
                  Gain insights into your top tracks, favorite artists, and
                  dynamic playlist trends.
                </Typography>
              </Grid>
              <Grid item xs={4}>
